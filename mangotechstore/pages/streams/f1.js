...
export class F1 extends Component {
    ...
    render() {
        ...
        <div className='streams__f1-page'>
            {/* <Collapse.Group> */}
                <Collapse  title='Pick your Team' subtitle='Pick your favorite team to see some cool stats'>
                    <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6'>
                        <Button className='bg-merc-blue' onClick={() => this.handleTeamSelect('Merc')}>Mercedes</Button>
                        <Button className='bg-tifosi-red' onClick={() => this.handleTeamSelect('Ferrari')}>Ferrari</Button>

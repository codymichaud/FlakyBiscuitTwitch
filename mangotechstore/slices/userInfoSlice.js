...
export const fetchUserInfo = createAsyncThunk(
  ...
  async () => {
    const userResponse = axios.get(
      `https://api.twitch.tv/helix/users?id=${process.env.NEXT_PUBLIC_TWITCH_CHANNEL_ID}`,
      {
        headers: {
...
export const {
  pending: fetchUserInfoPending,
  fulfilled: fetchUserInfoFulfilled,
  rejected: fetchUserInfoRejected,
} = fetchUserInfo;
